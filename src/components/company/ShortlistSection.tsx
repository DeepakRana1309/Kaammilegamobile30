...
export function ShortlistSection({
  ...
  // Get unique jobs
  const jobs = ['all', ...Array.from(new Set(shortlistedCandidates.map(c => c.appliedFor)))];
          ...
          >
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2 mb-1">
                  ...
                  <span className="bg-yellow-500/20 text-yellow-500 text-xs px-2 py-1 rounded-full whitespace-nowrap flex items-center gap-1">
            ...
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-2">
                <div className="w-24 h-2 bg-[#0A0F1C] rounded-full overflow-hidden">
                  <div
                    className={`h-full rounded-full ${
                      candidate.matchScore >= 90 ? 'bg-green-500' : 'bg-orange-500'
                    }`}
                    style={{ width: `${candidate.matchScore}%` }}
                  ></div>
                </div>
                <span className={`text-sm ${
                  candidate.matchScore >= 90 ? 'text-green-500' : 'text-orange-500'
                }`}>
            ...
            <div className="grid grid-cols-2 gap-2 mb-3">
              <a
                ...
                className="bg-[#0A0F1C] text-gray-400 py-2 px-3 rounded-lg text-xs hover:bg-[#141A2A] transition-all flex items-center justify-center gap-2"
              >
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="bg-purple-500 text-white py-3 rounded-xl text-sm hover:bg-purple-600 transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="bg-[#007BFF] text-white py-3 rounded-xl text-sm hover:bg-[#0066CC] transition-all"
              >
                View Profile
              </button>
            </div>
